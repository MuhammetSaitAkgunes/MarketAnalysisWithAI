...
degerler = dataFrame[["usd_faiz_6","usd_faiz_12","usd_faiz_12p","tufe_12","dis_borc"]].values
...
model.fit(deger_train, fiyat_train, epochs=300)
...
testTahminleri = pd.Series(testTahminleri.reshape(375,))
